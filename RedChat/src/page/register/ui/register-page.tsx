import AuthForm from '@/ui/layout/auth/auth-form'
import Head, {HeadType}  from '@/ui/layout/auth/head'
import Safety from '@/ui/layout/auth/salfety'
import UpLink from '@/ui/layout/auth/upLink'
...
export function RegisterPage(){
    return(
            ...
            <div className="relative w-full max-w-md z-10">
                ...
                ">
                    <Head
                    type={HeadType.REGISTER}
                    />
                    <AuthForm />
                    <UpLink 
                        authQuestion="Уже есть аккаунт"
                        formType="Войти"
                        to='/login'
                    />
                </div>
